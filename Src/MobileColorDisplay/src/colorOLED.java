...
public class colorOLED extends MIDlet implements CommandListener {
	...
	private final Command SCR_SEARCH_CANCEL_CMD = new Command("Back",
			Command.BACK, 2);
	...
	public void commandAction(Command c, Displayable d) {
		if (c == EXIT_CMD) {
			...
			// f.append(new Gauge("Searching images...", false,
...
//				do_alert("Flag A", 10000);
//				
//				port2 = ports.substring(comma + 1, 4);
//				do_alert("Flag B", 10000);
//			} else {
